...
import '../data/contracts/auth/auth_online_datasource.dart' as _i3;
import '../data/data_source/auth/auth_online_data_source_imp.dart' as _i4;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.AuthOnlineDataSource>(
        () => _i4.AuthOnlineDataSourceImpl(gh<_i5.ApiManager>()));
    gh.factory<_i6.ForgetPasswordRepo>(
        () => _i7.ForgetPasswordRepoImpl(gh<_i3.AuthOnlineDataSource>()));
    ...
    gh.factory<_i10.ResetPasswordRepo>(
        () => _i11.ResetPasswordRepoImpl(gh<_i3.AuthOnlineDataSource>()));
    ...
    gh.factory<_i13.VerifyResetCodeRepository>(
        () => _i14.VerifyResetCodeImpl(gh<_i3.AuthOnlineDataSource>()));
